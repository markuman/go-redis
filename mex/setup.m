...
if (exist('OCTAVE_VERSION', 'builtin') == 5)
    ...
    if isunix
        try
            mkoctfile -lhiredis -I/usr/include/hiredis --mex -fPIC -O2 -g redis_.cpp -o redis_.mex
        catch
    ...
    if isunix
        try
            mex -lhiredis -I/usr/include/hiredis/ CFLAGS='-fPIC -O2 -g' redis_.cpp -o ../inst/private/redis_.mexa64
        catch
